...
Before generating the PRD, you MUST use AskUserQuestion to confirm the following with the user:

1. **Target Users** — Who are the primary users of this product?
2. **Core Features for MVP** — What are the must-have features for the initial release?
3. **Technology Preferences** — Are there specific technologies, frameworks, or platforms to use?
4. **Success Criteria** — How will success be measured for this product?

Do not proceed with PRD generation until all four items are confirmed.
